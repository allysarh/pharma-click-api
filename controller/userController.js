...
module.exports = {
  ...
  getUser: async (req, res, next) => {
    try {
      ...
      getUser = await dbQuery(getUser);
      let getAddress = `SELECT a.id,a.tag,a.recipient,a.id_city_origin,a.iduser,c.name,a.address,a.postal_code from address a join city c on a.id_city_origin = c.id;`;
      getAddress = await dbQuery(getAddress);
      ...
      getUser.forEach((item, index) => {
        ...
        getAddress.forEach((e, idx) => {
          //console.log("isiaddress", getAddress);

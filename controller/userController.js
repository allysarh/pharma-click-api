  ...
  getHistoryTransaction: async (req, res, next) => {
    try {
      ...
      if (dataSearch.length > 0) {
        ...
        historyTrans = `SELECT t.id,t.idtype, t.iduser as iduser, t.invoice,c.name as origin, ct.name as destination,t.recipient,t.address,t.postal_code,t.shipping_cost,ts.name as status_name,t.total_price,t.note,t.img_order_url,t.id_city_origin,t.id_city_destination,t.expedition,t.service FROM transaction t 
        ...
        historyTrans = `SELECT t.id,t.idtype, t.iduser as iduser, t.invoice,c.name as destination, ct.name as destination,t.recipient,t.address,t.postal_code,t.shipping_cost,ts.name as status_name,t.total_price,t.note,t.img_order_url,t.id_city_origin,t.id_city_destination,t.expedition,t.service,es.name FROM transaction t 
        join user u on u.iduser=t.iduser 
        join transaction_status ts on t.id_transaction_status=ts.id 

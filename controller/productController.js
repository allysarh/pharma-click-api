        ...
        try {
            ...
            upload(req, res, async (error) => {
                try {
                    ...
                    let addProduct = `INSERT into product values (null, ${db.escape(product_name)}, ${db.escape(brand)}, 1,${db.escape(idcategory)}, ${db.escape(description)}, ${db.escape(effect)}, ${db.escape(usage)}, ${db.escape(dosage)}, ${db.escape(indication)}, ${db.escape(netto)}, ${db.escape(pack_price)}, ${db.escape(unit)}, now(), now());`
